...
class GruposServiceTest {
    ...
    //    @Test
//    //Regla: total >= 0
//    //Test: total negativo -> error //CHECK
//    //Test: total positivo -> bien  //CHECK
//    //Test: total 0 -> bien
...
//
//        assertThatThrownBy( () ->
//                            grupo.setTotal( new BigDecimal( "-1" ) )
...
//    }
    ...
    // Primero happy path
    // Test: total positivo debe ser valido
    // Test: total negativo debe fallar
    // Test: total igual a cero debe ser valido
    @Test
    void totalPositivoDebeSerValido(){
        Grupo grupo = new Grupo();

        grupo.setTotal(new BigDecimal("100"));

        assertEquals(new BigDecimal("100"),grupo.getTotal());
    }
